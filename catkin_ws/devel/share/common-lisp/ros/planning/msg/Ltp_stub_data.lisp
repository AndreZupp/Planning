...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Ltp_stub_data>)))
  ...
  "0adff1f38b5eb2ec9093634e8ac3d48c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Ltp_stub_data)))
  "Returns md5sum for a message object of type 'Ltp_stub_data"
  "0adff1f38b5eb2ec9093634e8ac3d48c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Ltp_stub_data>)))
  ...
  (cl:format cl:nil "Car_info car_info~%Track_map map~%State_machine state_machine~%================================================================================~%MSG: planning/Car_info~%float32 speed ~%float32 angle~%int8 cpu_temperature~%int8 engine_temperature~%int8 brake_temperature~%float32 fuel_level~%================================================================================~%MSG: planning/Track_map~%uint8[] track_map ~%uint32 car_position_x~%uint32 car_position_y~%================================================================================~%MSG: planning/State_machine~%string state~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Ltp_stub_data)))
  "Returns full string definition for message of type 'Ltp_stub_data"
  (cl:format cl:nil "Car_info car_info~%Track_map map~%State_machine state_machine~%================================================================================~%MSG: planning/Car_info~%float32 speed ~%float32 angle~%int8 cpu_temperature~%int8 engine_temperature~%int8 brake_temperature~%float32 fuel_level~%================================================================================~%MSG: planning/Track_map~%uint8[] track_map ~%uint32 car_position_x~%uint32 car_position_y~%================================================================================~%MSG: planning/State_machine~%string state~%~%"))
