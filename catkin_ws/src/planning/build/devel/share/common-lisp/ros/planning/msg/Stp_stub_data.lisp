...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Stp_stub_data>)))
  ...
  (cl:format cl:nil "Ray_cast ray_cast~%State_machine state_machine~%Car_info car_info~%# Command ltp_command~%================================================================================~%MSG: planning/Ray_cast~%float32[120] raycast~%~%================================================================================~%MSG: planning/State_machine~%string state~%================================================================================~%MSG: planning/Car_info~%float32 speed ~%float32 angle~%int8 cpu_temperature~%int8 engine_temperature~%int8 brake_temperature~%float32 fuel_level~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Stp_stub_data)))
  "Returns full string definition for message of type 'Stp_stub_data"
  (cl:format cl:nil "Ray_cast ray_cast~%State_machine state_machine~%Car_info car_info~%# Command ltp_command~%================================================================================~%MSG: planning/Ray_cast~%float32[120] raycast~%~%================================================================================~%MSG: planning/State_machine~%string state~%================================================================================~%MSG: planning/Car_info~%float32 speed ~%float32 angle~%int8 cpu_temperature~%int8 engine_temperature~%int8 brake_temperature~%float32 fuel_level~%~%"))
